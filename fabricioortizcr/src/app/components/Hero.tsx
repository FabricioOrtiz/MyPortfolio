        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
              Marco Fabricio Ortiz Alfaro
            </h1>
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-700 dark:text-gray-300">
              Full Stack Developer
            </h2>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
            I'm developer with 6+ years of experience. Ambitious,
responsible, hard working, and autodidact. 
With experience in C#, NextJS, react, Sql server, MongoDB, Exppress and nodeJS
            </p>

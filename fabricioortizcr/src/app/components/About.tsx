...
export default function About() {
  const skills = [
    ...
    { icon: <Server className="w-8 h-8 text-green-500" />, title: "Backend", description: ".Net, Node.js, Express, Fastify" },
    { icon: <Database className="w-8 h-8 text-purple-500" />, title: "Database", description: "SQL Server, MongoDB, Mongoose" },
